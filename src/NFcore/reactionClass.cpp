...
void ReactionClass::printDetails() const {
  ...
  if(n_reactants==0) cout<<"      >No Reactants: so this rule either creates new species or does nothing." <<endl;
  //cout<<"\n";
}

string ReactionClass::getRxnTemplate1(unsigned int r) const { return this->reactantTemplates[r]->getPatternString(); };
