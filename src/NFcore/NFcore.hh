	...
	class System
	{
		...
		public:
			...
			*/
			...
			bool isOutputtingEventHistory1() { return useEventHistory1; }; // LQI
			bool isOutputtingBinary1() { return useBinaryOutput1; }; // LQI
			...
			void setEventHistory1(); // LQI
			void setEventHistoryBin1(); // LQI
			void registerOutputFileLocation(string filename);
			void registerOutputFileLocation1(string filename); // LQI
	        ...
	        NFstream& getOutputFileStream1(); // LQI	
		...
		protected:
			...
			bool useBinaryOutput1; // LQI
			bool useEventHistory1; // LQI
			...
			NFstream outputFileStream1; // LQI: extra file to output reaction event history
	...
	*/
	class ReactionClass
	{
		...
		public:
			...
			unsigned int getFireCnt1() const { return fireCounter; };
			...
			// LQI
			string getRxnTemplate1(unsigned int r) const;
			...
			// LQI
			unsigned int getFireCounter() const { return fireCounter; };
